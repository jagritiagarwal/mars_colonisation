!function (t) {
  ...
  return function t(e, r, i) {
    ...
    5: [
      function (t, e) {
        function r(t, e, r,Nstop) {
          this.x = t,
          this.y = e,
          this.walkable = void 0 === r ? !0 : r
          this.Nstop = void 0 === Nstop ? !0 : Nstop
        }
        e.exports = r
      },
      {
      ...
      function (t, e) {
        ...
        r.prototype.findPath = function (t, e, r, i, o) {
          ...
          f = function (t, e, r, i, s) {
            if (h++, this.timeLimit > 0 && (new Date).getTime() - l > 1000 * this.timeLimit) return 1 / 0;
            ...
            for (y = 0, u = 1 / 0; b = A[y]; ++y) {
              if (this.trackRecursion && (b.retainCount = b.retainCount + 1 || 1, b.tested !== !0 && (b.tested = !0)), d = f(b, e + c(t, b), r, i, s + 1), d instanceof n) return i[s] = [
                t.x,
                t.y
              ],
              d;
    ...
    16: [
      function (t, e) {
        ...
        r.prototype._identifySuccessors = function (t) {
          ...
          A = t.y,
          k = Math.abs;
          for (Math.max, e = this._findNeighbors(t), n = 0, s = e.length; s > n; ++n) if (r = e[n], i = this._jump(r[0], r[1], b, A)) {
            if (a = i[0], u = i[1], p = c.getNodeAt(a, u), p.closed) continue;
            h = o.octile(k(a - b), k(u - A)),
            l = t.g + h,
            (!p.opened || l < p.g) && (p.g = l, p.h = p.h || f(k(a - g), k(u - y)), p.f = p.g + p.h, p.parent = t, p.opened ? d.updateItem(p)  : (d.push(p), p.opened = !0))
          }
        },
        r.prototype._jump = function (t, e, r, i) {
          ...
          e];
          if (0 !== o && 0 !== s) {
            if (n.isWalkableAt(t - o, e + s) && !n.isWalkableAt(t - o, e) || n.isWalkableAt(t + o, e - s) && !n.isWalkableAt(t, e - s)) return [t,
            e]
          } else if (0 !== o) {
            if (n.isWalkableAt(t + o, e + 1) && !n.isWalkableAt(t, e + 1) || n.isWalkableAt(t + o, e - 1) && !n.isWalkableAt(t, e - 1)) return [t,
            e]
          } else if (n.isWalkableAt(t + 1, e + s) && !n.isWalkableAt(t + 1, e) || n.isWalkableAt(t - 1, e + s) && !n.isWalkableAt(t - 1, e)) return [t,
          e];
          return 0 !== o && 0 !== s && (this._jump(t + o, e, t, e) || this._jump(t, e + s, t, e)) ? [
            t,
            e
          ] : n.isWalkableAt(t + o, e) || n.isWalkableAt(t, e + s) ? this._jump(t + o, e + s, t, e)  : null
        },
        r.prototype._findNeighbors = function (t) {
          ...
          0 !== i && 0 !== n ? (c.isWalkableAt(l, p + n) && f.push([l,
          p + n]), c.isWalkableAt(l + i, p) && f.push([l + i,
          p]), (c.isWalkableAt(l, p + n) || c.isWalkableAt(l + i, p)) && f.push([l + i,
          p + n]), !c.isWalkableAt(l - i, p) && c.isWalkableAt(l, p + n) && f.push([l - i,
          p + n]), !c.isWalkableAt(l, p - n) && c.isWalkableAt(l + i, p) && f.push([l + i,
          p - n]))  : 0 === i ? c.isWalkableAt(l, p + n) && (f.push([l,
          p + n]), c.isWalkableAt(l + 1, p) || f.push([l + 1,
          p + n]), c.isWalkableAt(l - 1, p) || f.push([l - 1,
          p + n]))  : c.isWalkableAt(l + i, p) && (f.push([l + i,
          p]), c.isWalkableAt(l, p + 1) || f.push([l + i,
          p + 1]), c.isWalkableAt(l, p - 1) || f.push([l + i,
          p - 1]));
      ...
      function (t, e) {
        ...
        r.prototype.findPath = function (t, e, r, o, s) {
          ...
          for (y.g = 0, y.f = 0, g.push(y), y.opened = !0; !g.empty(); ) {
            ...
            var x = u.length;
            for (l = 0, p = u.length; p > l; ++l) h = u[l],
            h.closed || (c = h.x, f = h.y, d = a.g + (0 === c - a.x || 0 === f - a.y ? 1 : w), (!h.opened || d < h.g) && (h.g = d * x / 9, h.h = h.h || A(v(c - r), v(f - o)), h.f = h.g + h.h, h.parent = a, h.opened ? g.updateItem(h)  : (g.push(h), h.opened = !0)))
          }
          return []
        },
        e.exports = r
    ...
    19: [
      function (t, e) {
        e.exports = {
          ...
          ClosestDestination:t('./finder/ClosestDestination')
        }
      },
      {
        './core/Grid': 3,
