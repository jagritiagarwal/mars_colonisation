    ...
    18: [
      ...
      // m = this.dontCrossCorners,
       ...
       r.prototype.findPath = function (t, e, r, o, s) {
        ...
        ast = function (t, e, r, o, s,diag,heur) {
          ...
          start = s.getNodeAt(t, e),
          b = s.getNodeAt(r, o);
          for (start.g = 0, start.f = 0, g.push(start), start.opened = !0; !g.empty(); ) {
            ...
            for (u = s.getNeighbors(a, k, m), l = 0, p = u.length; p > l; ++l) h = u[l],
            h.closed || (c = h.x, f = h.y, d = a.g + (0 === c - a.x || 0 === f - a.y ? 1 : x), (!h.opened || d < h.g) && (h.g = d, h.h = h.h || v * (heur(Math.abs(c - r), Math.abs(f - o))), h.f = h.g + h.h, h.parent = a, h.opened ? g.updateItem(h)  : (g.push(h), h.opened = !0)))
          }
          return [];
  ...
  e.exports = r
    ...
    21: [
      function (t, e) {
        e.exports = {
         ...
         closest_destination_bfs: t('./finders/closest_destination_bfs'),
          ...
          mutiple_visitation_bfs: t('./finders/mutiple_visitation_bfs'),
      ...
      },
      {
        ...
        './finders/mutiple_visitation_bfs': 15,
