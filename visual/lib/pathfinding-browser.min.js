  ...
  return function t(e, r, i) {
    ...
    3: [
      function (t, e) {
        ...
        r.prototype.setNstopAt = function (t, e,stop) {
          this.nodes[e][t].Nstop = stop
        },
          ...
          for (p.push(d), d.opened = !0; p.length; ) {
            if (u = p.shift(), u.closed = !0) {
              for(var k=0;k<stops.length;k++){
                ...
                if(u===stops[k]){alert(u.x);return util.backtrace(u);}}
              }
    ...
    18: [
      function (t, e) {
        ...
        var i = t('../core/Util');
                ...
                r.prototype.findPath = function (startx,starty,endx,endy, grid,bfs) {
        var stops=[]
        stops.push(grid.getNodeAt(endx,endy));
        var min=INT_MAX;
        var min_dest;
    ...
    19: [
      ...
      function (t, e) {
        ...
        return util.backtrace(min_dest);
        }
        e.exports = r
       },
       {
