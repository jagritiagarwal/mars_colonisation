  ...
  return function t(e, r, i) {
    ...
    15: [
     ...
     // alert(stops.length);
      ...
      var node=d;
      multi2=function(start,vis,stops,grid){
        var prev=[];
      var pr=100000000;
      var node=start;
      ...
      final.push(d);
      //alert(node.x);
      var x1=multi2(node,vis,stops,grid);
      while(x1.length){
        //alert(1);
    ...
    return e;
     var e=[[final[0].x,final[0].y]];
      for(var i=1;i<final.length;i++){
        e.push(final[i].x,final[i].y);
        //alert(final[i].y);
      }
      alert(e[e.length-1].x);
      alert(e[e.length-1].y);
      return e.reverse();
       ...
       r.prototype.findPath = function (t, e, r, o, s) {
        ...
        ast = function (t, e, r, o, s) {
          ...
          for (y.g = 0, y.f = 0, g.push(y), y.opened = !0; !g.empty(); ) {
            if (a = g.pop(), a.closed = !0, a === b) return n.backtrace(b);
            for (u = s.getNeighbors(a, k, m), l = 0, p = u.length; p > l; ++l) h = u[l],
            h.closed || (c = h.x, f = h.y, d = a.g + (0 === c - a.x || 0 === f - a.y ? 1 : x), (!h.opened || d < h.g) && (h.g = d, h.h = h.h || v * (this.heuristic(Math.abs(c - r), Math.abs(f - o))), h.f = h.g + h.h, h.parent = a, h.opened ? g.updateItem(h)  : (g.push(h), h.opened = !0)))
          }
          return [];
